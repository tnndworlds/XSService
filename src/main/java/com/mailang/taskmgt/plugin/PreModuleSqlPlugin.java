...
public class PreModuleSqlPlugin implements ParamPlugin
{
    private static SQLDao sqlExector = (SQLDao) SpringUtils.getBeanById("sqlDao");

    @Override
    public void execute(JOBEntity jobEntity, Map<String, Object> paramMap)
    {
        String moduleIds = String.valueOf(paramMap.get("preModules"));
